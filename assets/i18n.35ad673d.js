...
`)])],-1),F=s(" \u5207\u6362\u8BED\u8A00 "),j=n("h2",{id:"%E5%8F%AF%E9%85%8D%E7%BD%AE%E5%AD%97%E6%AE%B5",tabindex:"-1"},[s("\u53EF\u914D\u7F6E\u5B57\u6BB5 "),n("a",{class:"header-anchor",href:"#%E5%8F%AF%E9%85%8D%E7%BD%AE%E5%AD%97%E6%AE%B5","aria-hidden":"true"},"#")],-1),L=n("div",{class:"language-js"},[n("pre",null,[n("code",{"v-pre":""},[n("span",{class:"token keyword"},"const"),s(" locale "),n("span",{class:"token operator"},"="),s(),n("span",{class:"token punctuation"},"{"),s(`
  ...
  `),n("span",{class:"token punctuation"},"}"),n("span",{class:"token punctuation"},","),s(`
`),n("span",{class:"token punctuation"},"}"),s(`
`)])])],-1),M={setup(N,{expose:m}){m({frontmatter:{title:"\u56FD\u9645\u5316",meta:[{name:"description",content:"element-pro-components \u5982\u4F55\u8FDB\u884C\u56FD\u9645\u5316\u914D\u7F6E"},{property:"og:title",content:"\u56FD\u9645\u5316"}]}}),y({title:"\u56FD\u9645\u5316",meta:[{name:"description",content:"element-pro-components \u5982\u4F55\u8FDB\u884C\u56FD\u9645\u5316\u914D\u7F6E"},{property:"og:title",content:"\u56FD\u9645\u5316"}]});let t=k({}),d=k([{label:"Name",prop:"name",component:"el-input"}]),l=k(!1),g={name:"en",pro:{form:{submit:"Submit",reset:"Reset"}}},f={name:"zh-cn",pro:{form:{submit:"\u63D0 \u4EA4",reset:"\u91CD \u7F6E"}}},_=(i,o,u)=>{console.log(o,u),setTimeout(()=>{i()},1e3)},b=()=>{l.value=!l.value};return(i,o)=>{const u=e("el-button"),v=e("pro-form"),h=e("el-config-provider"),E=e("pro-code");return w(),x("div",D,[A,q,V,c(E,null,{code:p(()=>[C]),default:p(()=>[c(u,{type:"primary",style:{"margin-bottom":"20px"},onClick:a(b)},{default:p(()=>[F]),_:1},8,["onClick"]),c(h,{locale:a(l)?a(g):a(f)},{default:p(()=>[c(v,{modelValue:a(t),"onUpdate:modelValue":o[0]||(o[0]=r=>B(t)?t.value=r:t=r),columns:a(d),"label-width":"100px",onSubmit:a(_)},null,8,["modelValue","columns","onSubmit"])]),_:1},8,["locale"])]),_:1}),j,L])}}};export{M as default};
