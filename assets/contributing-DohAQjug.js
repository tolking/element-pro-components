import{u as s}from"./vue.f36acd1f-D8xt85SV.js";import{r,o as l,c as d,a as e,b as n,d as a,e as i}from"./index-DQtG-xXj.js";const c={class:"markdown-body"},h=i('<h1 id="贡献指南" tabindex="-1">贡献指南 <a class="header-anchor md-link" href="#贡献指南" aria-hidden="true">#</a></h1><p>感谢你使用 element-pro-components，如果你愿意贡献代码或提供建议，请阅读以下内容。</p><h2 id="issue-规范" tabindex="-1">Issue 规范 <a class="header-anchor md-link" href="#issue-规范" aria-hidden="true">#</a></h2><ul><li>遇到问题时，请先确认这个问题是否已经在 issue 中有记录或者已被修复。</li><li>提 issue 时，请用简短的语言描述遇到的问题，并添加出现问题时的环境和复现步骤。</li></ul><h2 id="pull-request-规范" tabindex="-1">Pull Request 规范 <a class="header-anchor md-link" href="#pull-request-规范" aria-hidden="true">#</a></h2><ul><li>在进行大型更改之前，最好先打开一个问题或者讨论与维护人员讨论。</li><li>如果遇到问题，建议保持你的 PR 足够小。保证一个 PR 只解决单个问题、添加单个功能。</li><li>当新增组件或者修改原有组件时，记得增加或者修改对应的单元测试，保证代码的稳定。</li><li>确保代码通过格式化及测试 (<code>pnpm check &amp;&amp; pnpm test</code>)。</li><li>提交 PR 前请 rebase，确保 commit 记录的整洁。</li><li>在 PR 中请添加合适的描述，并关联相关的 Issue。</li></ul><h2 id="git-提交信息规范" tabindex="-1">Git 提交信息规范 <a class="header-anchor md-link" href="#git-提交信息规范" aria-hidden="true">#</a></h2><p>消息必须由以下正则表达式匹配</p>',8),p=e("div",{class:"language-"},[e("pre",null,[e("code",{"v-pre":""},`/^(revert: )?(feat|fix|docs|dx|style|refactor|perf|test|workflow|build|ci|chore|types|wip)(\\(.+\\))?: .{1,50}/
