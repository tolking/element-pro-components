...
`)])],-1),Cn=n("i",{class:"el-icon-picture-outline"},null,-1),Un=n("span",null,"picture",-1),Ln=["src"],Rn={key:1,class:"el-icon-plus avatar-uploader-icon"},Wn=n("h3",{id:"custom-menu",tabindex:"-1"},[t("Custom Menu "),n("a",{class:"header-anchor",href:"#custom-menu","aria-hidden":"true"},"#")],-1),zn=n("p",null,[t("Set "),n("code",null,"menu"),t(" attribute to enable custom menu")],-1),In=t("Menu can also be configured through "),An=t("Global config"),Mn=t(" or "),Gn=t("Localization"),En=n("pre",null,[n("code",{"v-pre":""},[n("span",{class:"token tag"},[n("span",{class:"token tag"},[n("span",{class:"token punctuation"},"<"),t("template")]),n("span",{class:"token punctuation"},">")]),t(`
  `),n("span",{class:"token tag"},[n("span",{class:"token tag"},[n("span",{class:"token punctuation"},"<"),t("pro-form")]),t(`
    `),n("span",{class:"token attr-name"},"v-model"),n("span",{class:"token attr-value"},[n("span",{class:"token punctuation attr-equals"},"="),n("span",{class:"token punctuation"},'"'),t("form"),n("span",{class:"token punctuation"},'"')]),t(`
    `),n("span",{class:"token attr-name"},":columns"),n("span",{class:"token attr-value"},[n("span",{class:"token punctuation attr-equals"},"="),n("span",{class:"token punctuation"},'"'),t("columns"),n("span",{class:"token punctuation"},'"')]),t(`
...
`),n("span",{class:"token punctuation"},"}"),t(`
`)])]),n("span",{class:"token tag"},[n("span",{class:"token tag"},[n("span",{class:"token punctuation"},"</"),t("script")]),n("span",{class:"token punctuation"},">")]),t(`
`)])],-1),Jn=n("h3",{id:"custom-children-form",tabindex:"-1"},[t("Custom children form "),n("a",{class:"header-anchor",href:"#custom-children-form","aria-hidden":"true"},"#")],-1),On=n("p",null,[t("Set "),n("code",null,"children"),t(" in "),n("code",null,"columns"),t(" attribute to enable custom children form")],-1),Hn=n("pre",null,[n("code",{"v-pre":""},[n("span",{class:"token tag"},[n("span",{class:"token tag"},[n("span",{class:"token punctuation"},"<"),t("template")]),n("span",{class:"token punctuation"},">")]),t(`
  `),n("span",{class:"token tag"},[n("span",{class:"token tag"},[n("span",{class:"token punctuation"},"<"),t("pro-form")]),t(`
...
`),n("span",{class:"token punctuation"},"}"),t(`
`)])]),n("span",{class:"token tag"},[n("span",{class:"token tag"},[n("span",{class:"token punctuation"},"</"),t("script")]),n("span",{class:"token punctuation"},">")]),t(`
`)])],-1),Bn=n("h3",{id:"validation",tabindex:"-1"},[t("Validation "),n("a",{class:"header-anchor",href:"#validation","aria-hidden":"true"},"#")],-1),Kn=n("p",null,[t("Set "),n("code",null,"rules"),t(" attribute to enable validation, or Set "),n("code",null,"rules"),t(" in "),n("code",null,"columns"),t(" attribute to enable validation, or reference "),n("code",null,"${parental prop}.${current index}.${current prop}")],-1),Qn=n("pre",null,[n("code",{"v-pre":""},[n("span",{class:"token tag"},[n("span",{class:"token tag"},[n("span",{class:"token punctuation"},"<"),t("template")]),n("span",{class:"token punctuation"},">")]),t(`
  `),n("span",{class:"token tag"},[n("span",{class:"token tag"},[n("span",{class:"token punctuation"},"<"),t("pro-form")]),t(`
