import{u as w}from"./index.504b1133.js";import{s as i,H as e,o as x,z,a as c,M as p,L as n,a3 as s,v as a,l as S}from"./modules-vue.9811d525.js";import"./modules-element-plus.d32f8c51.js";const q={class:"markdown-body"},V=n("h1",{id:"internationalization",tabindex:"-1"},[s("Internationalization "),n("a",{class:"header-anchor",href:"#internationalization","aria-hidden":"true"},"#")],-1),I=n("h2",{id:"configuration",tabindex:"-1"},[s("configuration "),n("a",{class:"header-anchor",href:"#configuration","aria-hidden":"true"},"#")],-1),R=n("p",null,"Like elememt-plus, international configuration can be inject through ElConfigProvider",-1),j=n("pre",null,[n("code",{"v-pre":""},[n("span",{class:"token tag"},[n("span",{class:"token tag"},[n("span",{class:"token punctuation"},"<"),s("template")]),n("span",{class:"token punctuation"},">")]),s(`
...
`)])],-1),C=s(" Switch lang "),L=n("h2",{id:"configurable-fields",tabindex:"-1"},[s("Configurable fields "),n("a",{class:"header-anchor",href:"#configurable-fields","aria-hidden":"true"},"#")],-1),N=n("div",{class:"language-js"},[n("pre",null,[n("code",{"v-pre":""},[n("span",{class:"token keyword"},"const"),s(" locale "),n("span",{class:"token operator"},"="),s(),n("span",{class:"token punctuation"},"{"),s(`
  ...
  `),n("span",{class:"token punctuation"},"}"),n("span",{class:"token punctuation"},","),s(`
`),n("span",{class:"token punctuation"},"}"),s(`
`)])])],-1),D={setup(H,{expose:m}){m({frontmatter:{title:"Internationalization",meta:[{name:"description",content:"How to configure Internationalization of element-pro-components"},{property:"og:title",content:"Internationalization"}]}}),w({title:"Internationalization",meta:[{name:"description",content:"How to configure Internationalization of element-pro-components"},{property:"og:title",content:"Internationalization"}]});let t=i({}),d=i([{label:"Name",prop:"name",component:"el-input"}]),l=i(!0),g={name:"en",pro:{form:{submit:"Submit",reset:"Reset"}}},f={name:"zh-cn",pro:{form:{submit:"\u63D0 \u4EA4",reset:"\u91CD \u7F6E"}}},b=(k,o,u)=>{console.log(o,u),setTimeout(()=>{k()},1e3)},h=()=>{l.value=!l.value};return(k,o)=>{const u=e("el-button"),_=e("pro-form"),v=e("el-config-provider"),y=e("pro-code");return x(),z("div",q,[V,I,R,c(y,null,{code:p(()=>[j]),default:p(()=>[c(u,{type:"primary",style:{"margin-bottom":"20px"},onClick:a(h)},{default:p(()=>[C]),_:1},8,["onClick"]),c(v,{locale:a(l)?a(g):a(f)},{default:p(()=>[c(_,{modelValue:a(t),"onUpdate:modelValue":o[0]||(o[0]=r=>S(t)?t.value=r:t=r),columns:a(d),"label-width":"100px",onSubmit:a(b)},null,8,["modelValue","columns","onSubmit"])]),_:1},8,["locale"])]),_:1}),L,N])}}};export{D as default};
