import{u as G}from"./index.e0b94cb9.js";import{r as p,R as x,z as L,A as q,U as u,O as e,u as o,f as g,at as N,E as n,a3 as t}from"./modules-vue.fb389e96.js";import"./modules-element-plus.7b597c42.js";const V={class:"markdown-body"},C=N('<h1 id="columnsetting" tabindex="-1">ColumnSetting <a class="header-anchor" href="#columnsetting" aria-hidden="true">#</a></h1><blockquote><p>Control the sorting and display of columns in the table, use whit Table or Crud</p></blockquote><h2 id="use" tabindex="-1">Use <a class="header-anchor" href="#use" aria-hidden="true">#</a></h2><h3 id="use-with-table" tabindex="-1">Use with Table <a class="header-anchor" href="#use-with-table" aria-hidden="true">#</a></h3>',4),F=n("p",null,[t("Bind data through "),n("code",null,"v-model"),t(", click the multi-select box to togglen display and hide, and drag it directly to togglen sort")],-1),U=n("pre",null,[n("code",{"v-pre":""},[n("span",{class:"token tag"},[n("span",{class:"token tag"},[n("span",{class:"token punctuation"},"<"),t("template")]),n("span",{class:"token punctuation"},">")]),t(`
