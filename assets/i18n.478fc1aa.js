import{u as p}from"./index.427fa934.js";import{I as c}from"./base.8dc75a96.js";import{I as l,o as u,c as r,Q as t,O as a,a as n,a5 as s}from"./modules-vue.feae9409.js";import"./modules-element-plus.2aa38461.js";const i={class:"markdown-body"},k=n("h1",{id:"internationalization",tabindex:"-1"},[s("Internationalization "),n("a",{class:"header-anchor",href:"#internationalization","aria-hidden":"true"},"#")],-1),d=n("h2",{id:"configuration",tabindex:"-1"},[s("configuration "),n("a",{class:"header-anchor",href:"#configuration","aria-hidden":"true"},"#")],-1),m=n("p",null,"Like elememt-plus, international configuration can be inject through ElConfigProvider",-1),g=n("pre",null,[n("code",{"v-pre":""},[n("span",{class:"token tag"},[n("span",{class:"token tag"},[n("span",{class:"token punctuation"},"<"),s("template")]),n("span",{class:"token punctuation"},">")]),s(`
...
`)])],-1),y=n("p",null,"@/demo/I18n/base.vue",-1),f=n("h2",{id:"configurable-fields",tabindex:"-1"},[s("Configurable fields "),n("a",{class:"header-anchor",href:"#configurable-fields","aria-hidden":"true"},"#")],-1),h=n("div",{class:"language-js"},[n("pre",null,[n("code",{"v-pre":""},[n("span",{class:"token keyword"},"const"),s(" locale "),n("span",{class:"token operator"},"="),s(),n("span",{class:"token punctuation"},"{"),s(`
  ...
  `),n("span",{class:"token punctuation"},"}"),n("span",{class:"token punctuation"},","),s(`
`),n("span",{class:"token punctuation"},"}"),s(`
`)])])],-1),C="Internationalization",R=[{name:"description",content:"How to configure Internationalization of element-pro-components"},{property:"og:title",content:"Internationalization"}],S={setup(b,{expose:o}){return o({frontmatter:{title:"Internationalization",meta:[{name:"description",content:"How to configure Internationalization of element-pro-components"},{property:"og:title",content:"Internationalization"}]}}),p({title:"Internationalization",meta:[{name:"description",content:"How to configure Internationalization of element-pro-components"},{property:"og:title",content:"Internationalization"}]}),(w,I)=>{const e=l("pro-code");return u(),r("div",i,[k,d,m,t(e,null,{source:a(()=>[t(c)]),code:a(()=>[g]),default:a(()=>[y]),_:1}),f,h])}}};export{S as default,R as meta,C as title};
